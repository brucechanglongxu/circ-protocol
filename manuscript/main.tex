...
questions also include liability, regulatory classification, local configuration, alert burden, and
equitable access. These issues will play out differently under regimes such as the FDA's
device-centered framework and the European Union's risk-tiered AI Act.\cite{fda2021aiml,eu2024aiact}
Future work should compare protocol, orchestration, policy-engine, EHR-native, and human-led
implementations against common risk-specific endpoints.
